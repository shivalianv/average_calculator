...
//     OrderPriceController.addListener;
...
//     TextEditingController Ordervalue = OrderPriceController;
//     TextEditingController Sharevalue = ShareValueController;
//     // List<TextEditingController> Ordervalue = OrderPriceController;
//     // List<TextEditingController> Sharevalue = ShareValueController;
...
//      double OrderPrice = parseToDouble(Ordervalue.text);
//       double ShareValue = parseToDouble(Sharevalue.text);
...
//               //       newcompanyadd.customtextfield1,
//               //       newcompanyadd.customtextfield2,
//               //       // Text("${newcompanyadd.MarginDelivery}"),
//               //       // Text("${ newcompanyadd.MarginIntraday}"),
...
//                                       onchange: (value) {
//                                         setState(() {
//                                           OrderPriceController.text = value;
//                                           SelectedCompany1(index,
//                                               SelectedExchangevalue ?? '0.0');
//                                           CalculateOrder();
//                                         });
...
//                                       onchange: (value) {
//                                         setState(() {
//                                           ShareValueController.text = value;
//                                           SelectedCompany1(index,
//                                               SelectedExchangevalue ?? '0.0');
