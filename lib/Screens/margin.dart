...
//                   },
//                 ),
//                 textmargin_deliver: selected_buysellvalue == "SELL"
//                     ? '0.0'
//                     : selected_buysell_list,
...
//                     borderRadius: BorderRadius.circular(10),
//                   ),
//                   child: Center(child: Text(textmargin_deliver ?? "")),
//                 ),
//                 SizedBox(
//                   height: 10,
//                 ),
        ...
        items2: exchange_list.map((String? exchange_list) {
          return DropdownMenuItem<String>(
              ...
              child: Text(
                exchange_list!,
                style:
                    TextStyle(color: AppColors.primaryColorDark1, fontSize: 15),
              ));
        }).toList(),
        onchanged2: (newvalue2) {
          setState(() {
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ListView(
                  ...
                  children: addmultiple_companylist,
                ),
              ),
              SizedBox(
                height: 10,
